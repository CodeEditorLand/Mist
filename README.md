...
see the [`LICENSE`](https://github.com/CodeEditorLand/Mist/tree/Current/LICENSE) file.
...
[`CHANGELOG.md`](https://github.com/CodeEditorLand/Mist/tree/Current/CHANGELOG.md) for a
